...
| **TweakGPT - Show Project Name instead of Folder** | Replaces the project “folder” icon in the top bar with the actual project name (taken from aria-label), matching header typography. | 2026-01-17 | [Install](https://raw.githubusercontent.com/howermj/TweakGPT-scripts/main/tweakgpt-project-name-instead-of-folder-icon.user.js "https://raw.githubusercontent.com/howermj/TweakGPT-scripts/main/tweakgpt-gpt-or-project-name-in-header.user.js") |
